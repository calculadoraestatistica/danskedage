...
def render_tools_hub(g) -> None:
    ...
    body += '<section class="section"><div class="container narrow prose"><h2>Hvilket værktøj skal du bruge?</h2><p>Værktøjerne løser hver sin lille opgave, og de fleste spørgsmål om datoer falder i en af fire kategorier. Er du i tvivl, så start her.</p><h3>Du kender to datoer og vil vide, hvad der ligger imellem</h3><p><a href="beregn-arbejdsdage.html">Beregn arbejdsdage</a> tæller hverdage minus helligdage — det tal, der bruges til leveringstider, varsler og timenormering. <a href="dato-difference.html">Datoforskel</a> giver i stedet den fulde afstand i år, måneder, uger og dage, hvilket er det, du vil have til jubilæer og aldersberegning på tværs af lange perioder. <a href="aldersberegner.html">Aldersberegneren</a> er den samme øvelse specialiseret til fødselsdatoer.</p><h3>Du kender én dato og et antal dage</h3><p><a href="laeg-arbejdsdage-til.html">Læg arbejdsdage til</a> og <a href="traek-arbejdsdage-fra.html">Træk arbejdsdage fra</a> springer weekender og helligdage over — brug dem, når en frist er formuleret i arbejdsdage. Skal alle dage tælle med, uanset ugedag, er <a href="dato-plus-dage.html">Dato ± dage</a> den rigtige: en betalingsfrist på 30 dage betyder næsten altid kalenderdage, ikke arbejdsdage.</p><h3>Du skal oversætte mellem dato, uge og ugedag</h3><p><a href="ugenummer.html">Ugenummer</a> giver ISO-ugen for en dato, og <a href="dato-fra-uge.html">Dato fra ugenummer</a> gør det modsatte, når en aftale er lagt i «uge 34». <a href="ugedag.html">Ugedag</a> svarer på, hvilken dag i ugen en bestemt dato faldt på — nyttigt til alt fra historiske opslag til at kontrollere en gammel faktura.</p><h3>Du planlægger frem i tid</h3><p><a href="naeste-helligdag.html">Næste helligdag</a> viser den kommende fridag og de fem efterfølgende. <a href="nedtaelling.html">Nedtælling</a> laver et delbart link til en bestemt dato. Skal du lægge ferien, hvor den giver flest fridage for færrest feriedage, findes en beregning af det for hvert år under kalendersiderne.</p><h2>Fælles for alle værktøjerne</h2><p>Beregningerne kører i din browser — intet sendes til en server, og der kræves ikke login. Danske officielle helligdage er indregnet, mens 1. maj, grundlovsdag, juleaftensdag og nytårsaftensdag behandles som valgfri: de er ikke helligdage efter loven, men holdes fri mange steder, og derfor kan du vælge dem til, hvor det er relevant. Detaljerne står på <a href="metode.html">metodesiden</a>.</p></div></section>'
    g.write_page(
        "vaerktoejer.html",
