...
.btn{cursor:pointer;font:inherit;transition:background-color .15s ease,border-color .15s ease,box-shadow .15s ease}.btn:hover{box-shadow:0 4px 10px rgba(15,23,42,.1)}.btn--ghost:hover{background:#f2f6f3;border-color:#c8d2c9}
.card{transition:border-color .15s ease,box-shadow .15s ease,transform .15s ease}a.card:hover{border-color:#5eead4;transform:translateY(-2px)}
...
.calendar-grid span,.mini-calendar span{transition:background-color .15s ease,box-shadow .15s ease}.calendar-grid span[title],.mini-calendar span[title]{cursor:help}.calendar-grid span[title]:hover,.mini-calendar span[title]:hover{box-shadow:inset 0 0 0 2px rgba(15,118,110,.35)}
.calendar-grid .weekend,.mini-calendar .weekend{color:#475569}
.calendar-grid .today,.mini-calendar .today{outline-offset:-2px;font-weight:800}
.calendar-legend{background:#fbfcf9}.calendar-legend__swatch{box-shadow:inset 0 0 0 1px rgba(15,23,42,.05)}
tbody tr:nth-child(even) td{background:#fafbf8}tbody tr:hover td{background:#f0f6f4}
