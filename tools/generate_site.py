...
@media(max-width:780px){.hero-grid{grid-template-columns:1fr}.footer-grid{grid-template-columns:1fr}.section-title{display:block}.table-wrap{overflow-x:auto;-webkit-overflow-scrolling:touch}table{min-width:520px}.main-nav a{font-size:.86rem;padding:.45rem}.nav-toggle{display:inline-flex;align-items:center;gap:.4rem;font-weight:700}.main-nav{display:none;flex-basis:100%;order:3}.main-nav.is-open{display:block}.main-nav ul{flex-direction:column;gap:0;padding:.4rem 0}.main-nav a{display:block;width:100%;font-size:.95rem;padding:.6rem .3rem;border-bottom:1px solid var(--line)}.main-nav a[aria-current=page]{border-bottom:1px solid var(--line);background:var(--soft);color:var(--ink)}.site-header__inner{flex-wrap:wrap}.hero{padding:1.6rem 0 1.2rem}.hero h1{font-size:clamp(1.7rem,7vw,2.4rem)}.hero+.ad-slot--header{display:none}.hero+.ad-slot--header+.section{padding-top:1rem}}
